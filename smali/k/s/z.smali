...
.method public static final d()Ljava/util/Map;
    ...
    sget-object v0, Lk/s/t;->m:Lk/s/t;
...
.method public static final e(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_0
    invoke-static {p0}, Lk/s/y;->c(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_1
    invoke-static {}, Lk/s/z;->d()Ljava/util/Map;
...
.method public static g(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lk/s/z;->h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lk/s/y;->b(Lk/k;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lk/s/z;->h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    invoke-static {v0}, Lk/s/z;->e(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p0}, Lk/s/z;->f(Ljava/util/Map;Ljava/lang/Iterable;)V
