...
.field private final e:Li/a/c/b/a;
...
.field private final r:Li/a/c/d/m;
...
.method public constructor <init>(Landroid/content/Context;Lio/flutter/embedding/engine/h/f;Lio/flutter/embedding/engine/FlutterJNI;Li/a/c/d/m;[Ljava/lang/String;Z)V
    .locals 8
    ...
    invoke-direct/range {v0 .. v7}, Lio/flutter/embedding/engine/b;-><init>(Landroid/content/Context;Lio/flutter/embedding/engine/h/f;Lio/flutter/embedding/engine/FlutterJNI;Li/a/c/d/m;[Ljava/lang/String;ZZ)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lio/flutter/embedding/engine/h/f;Lio/flutter/embedding/engine/FlutterJNI;Li/a/c/d/m;[Ljava/lang/String;ZZ)V
    .locals 6
    ...
    invoke-virtual {v1}, Li/a/a;->d()Lio/flutter/embedding/engine/FlutterJNI$c;
    ...
    invoke-virtual {v2}, Lio/flutter/embedding/engine/f/d;->o()V

    invoke-static {}, Li/a/a;->e()Li/a/a;

    move-result-object v0

    invoke-virtual {v0}, Li/a/a;->a()Lio/flutter/embedding/engine/g/a;
    ...
    invoke-direct {v4, v2}, Lio/flutter/embedding/engine/j/d;-><init>(Li/a/c/a/c;)V
    ...
    :cond_1
    new-instance p7, Li/a/c/b/a;

    invoke-direct {p7, p1, v4}, Li/a/c/b/a;-><init>(Landroid/content/Context;Lio/flutter/embedding/engine/j/f;)V

    iput-object p7, p0, Lio/flutter/embedding/engine/b;->e:Li/a/c/b/a;

    if-nez p2, :cond_2

    invoke-virtual {v1}, Li/a/a;->c()Lio/flutter/embedding/engine/h/f;
    ...
    invoke-virtual {p2, v0}, Lio/flutter/embedding/engine/h/f;->q(Landroid/content/Context;)V

    invoke-virtual {p2, p1, p5}, Lio/flutter/embedding/engine/h/f;->e(Landroid/content/Context;[Ljava/lang/String;)V
    ...
    invoke-virtual {p3, p4}, Lio/flutter/embedding/engine/FlutterJNI;->setPlatformViewsController(Li/a/c/d/m;)V

    invoke-virtual {p3, p7}, Lio/flutter/embedding/engine/FlutterJNI;->setLocalizationPlugin(Li/a/c/b/a;)V

    invoke-virtual {v1}, Li/a/a;->a()Lio/flutter/embedding/engine/g/a;
    ...
    iput-object p4, p0, Lio/flutter/embedding/engine/b;->r:Li/a/c/d/m;

    invoke-virtual {p4}, Li/a/c/d/m;->M()V
    ...
    invoke-direct {p3, p1, p0, p2}, Lio/flutter/embedding/engine/d;-><init>(Landroid/content/Context;Lio/flutter/embedding/engine/b;Lio/flutter/embedding/engine/h/f;)V

    iput-object p3, p0, Lio/flutter/embedding/engine/b;->d:Lio/flutter/embedding/engine/d;

    if-eqz p6, :cond_5

    invoke-virtual {p2}, Lio/flutter/embedding/engine/h/f;->d()Z
...
.method public constructor <init>(Landroid/content/Context;Lio/flutter/embedding/engine/h/f;Lio/flutter/embedding/engine/FlutterJNI;[Ljava/lang/String;Z)V
    .locals 7

    new-instance v4, Li/a/c/d/m;

    invoke-direct {v4}, Li/a/c/d/m;-><init>()V
    ...
    invoke-direct/range {v0 .. v6}, Lio/flutter/embedding/engine/b;-><init>(Landroid/content/Context;Lio/flutter/embedding/engine/h/f;Lio/flutter/embedding/engine/FlutterJNI;Li/a/c/d/m;[Ljava/lang/String;Z)V
...
.method public constructor <init>(Landroid/content/Context;[Ljava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v5}, Lio/flutter/embedding/engine/b;-><init>(Landroid/content/Context;Lio/flutter/embedding/engine/h/f;Lio/flutter/embedding/engine/FlutterJNI;[Ljava/lang/String;Z)V
...
.method static synthetic b(Lio/flutter/embedding/engine/b;)Li/a/c/d/m;
    .locals 0

    iget-object p0, p0, Lio/flutter/embedding/engine/b;->r:Li/a/c/d/m;
...
.method public e()V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/d;->j()V

    iget-object v0, p0, Lio/flutter/embedding/engine/b;->r:Li/a/c/d/m;

    invoke-virtual {v0}, Li/a/c/d/m;->O()V

    iget-object v0, p0, Lio/flutter/embedding/engine/b;->c:Lio/flutter/embedding/engine/f/d;

    invoke-virtual {v0}, Lio/flutter/embedding/engine/f/d;->p()V
...
.method public k()Li/a/c/b/a;
    .locals 1

    iget-object v0, p0, Lio/flutter/embedding/engine/b;->e:Li/a/c/b/a;
