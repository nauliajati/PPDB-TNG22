...
.field private localizationPlugin:Li/a/c/b/a;
...
.field private platformViewsController:Li/a/c/d/m;
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p2, p0}, Li/a/b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    invoke-interface {v0, p1, p2}, Lio/flutter/embedding/engine/f/f;->f(ILjava/nio/ByteBuffer;)V
...
.method public computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Li/a/c/b/a;
    ...
    :cond_5
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Li/a/c/b/a;

    invoke-virtual {p1, v0}, Li/a/c/b/a;->c(Ljava/util/List;)Ljava/util/Locale;
...
.method public createOverlaySurface()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Li/a/c/d/m;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Li/a/c/d/m;->w()Lio/flutter/embedding/engine/FlutterOverlaySurface;
...
.method public destroyOverlaySurfaces()V
    ...
    invoke-virtual {v0}, Li/a/c/d/m;->y()V
...
.method public dispatchEmptyPlatformMessage(Ljava/lang/String;I)V
    ...
    invoke-static {p2, p1}, Li/a/b;->f(Ljava/lang/String;Ljava/lang/String;)V
...
.method public dispatchSemanticsAction(ILio/flutter/view/c$g;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p3}, Li/a/c/a/r;->a(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
...
.method public invokePlatformMessageEmptyResponseCallback(I)V
    ...
    invoke-static {v0, p1}, Li/a/b;->f(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onBeginFrame()V
    ...
    invoke-virtual {v0}, Li/a/c/d/m;->N()V
...
.method public onDisplayOverlaySurface(IIIII)V
    ...
    invoke-virtual/range {v0 .. v5}, Li/a/c/d/m;->P(IIIII)V
...
.method public onDisplayPlatformView(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    iget-object v1, v0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Li/a/c/d/m;
    ...
    invoke-virtual/range {v1 .. v9}, Li/a/c/d/m;->Q(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
...
.method public onEndFrame()V
    ...
    invoke-virtual {v0}, Li/a/c/d/m;->R()V
...
.method public setLocalizationPlugin(Li/a/c/b/a;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Li/a/c/b/a;
...
.method public setPlatformViewsController(Li/a/c/d/m;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Li/a/c/d/m;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, p3}, Li/a/d/b;->a(ZLjava/lang/Object;)V
