...
.method public static final a(Lkotlinx/coroutines/s0;I)V
    ...
    iget-object p1, p1, Lkotlinx/coroutines/internal/g;->p:Lkotlinx/coroutines/f0;

    invoke-interface {v0}, Lk/u/d;->getContext()Lk/u/g;

    move-result-object v0

    invoke-virtual {p1, v0}, Lkotlinx/coroutines/f0;->y(Lk/u/g;)Z
    ...
    :cond_5
    invoke-static {p0, v0, v1}, Lkotlinx/coroutines/t0;->d(Lkotlinx/coroutines/s0;Lk/u/d;Z)V
...
.method public static final d(Lkotlinx/coroutines/s0;Lk/u/d;Z)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    sget-object p0, Lk/l;->m:Lk/l$a;

    invoke-static {v1}, Lk/m;->a(Ljava/lang/Throwable;)Ljava/lang/Object;
    ...
    iget-object p2, p1, Lkotlinx/coroutines/internal/g;->q:Lk/u/d;

    iget-object v0, p1, Lkotlinx/coroutines/internal/g;->s:Ljava/lang/Object;

    invoke-interface {p2}, Lk/u/d;->getContext()Lk/u/g;

    move-result-object v1

    invoke-static {v1, v0}, Lkotlinx/coroutines/internal/d0;->c(Lk/u/g;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p2, v1, v0}, Lkotlinx/coroutines/e0;->e(Lk/u/d;Lk/u/g;Ljava/lang/Object;)Lkotlinx/coroutines/g2;
    ...
    :goto_1
    :try_start_0
    iget-object p1, p1, Lkotlinx/coroutines/internal/g;->q:Lk/u/d;

    invoke-interface {p1, p0}, Lk/u/d;->resumeWith(Ljava/lang/Object;)V

    sget-object p0, Lk/r;->a:Lk/r;
    :try_end_0
    ...
    :cond_2
    invoke-static {v1, v0}, Lkotlinx/coroutines/internal/d0;->a(Lk/u/g;Ljava/lang/Object;)V
...
.method private static final e(Lkotlinx/coroutines/s0;)V
    ...
    invoke-static {p0, v2, v1}, Lkotlinx/coroutines/t0;->d(Lkotlinx/coroutines/s0;Lk/u/d;Z)V
