...
.method static constructor <clinit>()V
    ...
    sput-object v2, Lkotlinx/coroutines/z0;->q:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Lkotlinx/coroutines/z0;->r:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method public static final synthetic M(Lkotlinx/coroutines/z0;)Z
    .locals 0

    invoke-direct {p0}, Lkotlinx/coroutines/z0;->R()Z
...
.method private final N()V
    ...
    sget-object v0, Lkotlinx/coroutines/z0;->q:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sget-object v2, Lkotlinx/coroutines/z0;->q:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method private final Q(Ljava/lang/Runnable;)Z
    ...
    :cond_4
    sget-object v1, Lkotlinx/coroutines/z0;->q:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sget-object v3, Lkotlinx/coroutines/z0;->q:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method private final U()V
    ...
    :cond_2
    invoke-virtual {p0, v0, v1, v2}, Lkotlinx/coroutines/a1;->K(JLkotlinx/coroutines/z0$a;)V

    goto :goto_0
.end method

.method private final X(JLkotlinx/coroutines/z0$a;)I
    .locals 3
    ...
    :cond_1
    invoke-virtual {p3, p1, p2, v0, p0}, Lkotlinx/coroutines/z0$a;->k(JLkotlinx/coroutines/z0$b;Lkotlinx/coroutines/z0;)I
...
.method private final Z(Lkotlinx/coroutines/z0$a;)Z
    .locals 1
...
.method protected C()J
    ...
    invoke-super {p0}, Lkotlinx/coroutines/y0;->C()J
    ...
    :cond_4
    iget-wide v0, v0, Lkotlinx/coroutines/z0$a;->m:J
    ...
    invoke-static {v0, v1, v2, v3}, Lk/z/d;->b(JJ)J
...
.method protected I()V
    ...
    invoke-direct {p0, v0}, Lkotlinx/coroutines/z0;->Y(Z)V

    invoke-direct {p0}, Lkotlinx/coroutines/z0;->N()V
    ...
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/z0;->U()V
...
.method public final P(Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0, p1}, Lkotlinx/coroutines/z0;->Q(Ljava/lang/Runnable;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lkotlinx/coroutines/a1;->L()V
    ...
    invoke-virtual {v0, p1}, Lkotlinx/coroutines/z0;->P(Ljava/lang/Runnable;)V
...
.method protected S()Z
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/y0;->G()Z
...
.method public T()J
    ...
    invoke-virtual {v5, v3, v4}, Lkotlinx/coroutines/z0$a;->l(J)Z
    ...
    invoke-direct {p0, v5}, Lkotlinx/coroutines/z0;->Q(Ljava/lang/Runnable;)Z
    ...
    :cond_6
    :goto_4
    invoke-direct {p0}, Lkotlinx/coroutines/z0;->O()Ljava/lang/Runnable;
    ...
    :cond_7
    invoke-virtual {p0}, Lkotlinx/coroutines/z0;->C()J
...
.method public final W(JLkotlinx/coroutines/z0$a;)V
    .locals 2

    invoke-direct {p0, p1, p2, p3}, Lkotlinx/coroutines/z0;->X(JLkotlinx/coroutines/z0$a;)I
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lkotlinx/coroutines/a1;->K(JLkotlinx/coroutines/z0$a;)V

    goto :goto_0

    :cond_2
    invoke-direct {p0, p3}, Lkotlinx/coroutines/z0;->Z(Lkotlinx/coroutines/z0$a;)Z
...
.method public final x(Lk/u/g;Ljava/lang/Runnable;)V
    .locals 0

    invoke-virtual {p0, p2}, Lkotlinx/coroutines/z0;->P(Ljava/lang/Runnable;)V
