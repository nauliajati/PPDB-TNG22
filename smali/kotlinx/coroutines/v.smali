...
# static fields
.field public static final n:Lkotlinx/coroutines/v;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkotlinx/coroutines/v;->n:Lkotlinx/coroutines/v;
    ...
    :cond_0
    invoke-static {v0}, Lk/c0/d;->f(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    :goto_1
    sput v0, Lkotlinx/coroutines/v;->o:I
...
.method private final B()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/v;->z()Ljava/util/concurrent/ExecutorService;
    ...
    :cond_1
    sget-boolean v2, Lkotlinx/coroutines/v;->p:Z

    const/4 v3, 0x0

    if-nez v2, :cond_6

    sget v2, Lkotlinx/coroutines/v;->o:I
    ...
    :cond_3
    sget-object v4, Lkotlinx/coroutines/v;->n:Lkotlinx/coroutines/v;
...
.method private final declared-synchronized C()Ljava/util/concurrent/Executor;
    .locals 1
...
.method private final D()I
    ...
    sget v0, Lkotlinx/coroutines/v;->o:I
    ...
    invoke-static {v0, v2}, Lk/z/d;->a(II)I
...
.method public static synthetic G()V
    ...
    invoke-static {}, Lkotlinx/coroutines/v;->F()V

    return-void
.end method

.method public static synthetic H(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Runnable;)Ljava/lang/Thread;
    .locals 0
...
.method private final z()Ljava/util/concurrent/ExecutorService;
    .locals 3
...
.method public x(Lk/u/g;Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/v;->C()Ljava/util/concurrent/Executor;
    ...
    :goto_1
    sget-object p1, Lkotlinx/coroutines/q0;->s:Lkotlinx/coroutines/q0;

    invoke-virtual {p1, p2}, Lkotlinx/coroutines/z0;->P(Ljava/lang/Runnable;)V
