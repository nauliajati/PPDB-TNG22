...
.method public static c(Landroid/graphics/drawable/Icon;)Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {p0}, Landroidx/core/graphics/drawable/IconCompat;->t(Landroid/graphics/drawable/Icon;)I
    ...
    :cond_0
    invoke-static {p0}, Landroidx/core/graphics/drawable/IconCompat;->v(Landroid/graphics/drawable/Icon;)Landroid/net/Uri;
    ...
    invoke-static {p0}, Landroidx/core/graphics/drawable/IconCompat;->q(Landroid/graphics/drawable/Icon;)Ljava/lang/String;

    move-result-object v1

    invoke-static {p0}, Landroidx/core/graphics/drawable/IconCompat;->o(Landroid/graphics/drawable/Icon;)I
...
.method private static o(Landroid/graphics/drawable/Icon;)I
    .locals 6
...
.method private static q(Landroid/graphics/drawable/Icon;)Ljava/lang/String;
    .locals 7
...
.method private static r(Landroid/content/Context;Ljava/lang/String;)Landroid/content/res/Resources;
    .locals 3
...
.method private static t(Landroid/graphics/drawable/Icon;)I
    .locals 7
...
.method private static v(Landroid/graphics/drawable/Icon;)Landroid/net/Uri;
    .locals 7
...
.method private y(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    .locals 5
    ...
    :cond_1
    invoke-static {p1, v0}, Landroidx/core/graphics/drawable/IconCompat;->r(Landroid/content/Context;Ljava/lang/String;)Landroid/content/res/Resources;
    ...
    invoke-static {v0, v3, p1}, Le/c/h/e/a;->a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method public D(Landroid/content/Context;)Landroid/graphics/drawable/Icon;
    ...
    invoke-virtual {p0}, Landroidx/core/graphics/drawable/IconCompat;->u()Landroid/net/Uri;
...
.method public p()Ljava/lang/String;
    ...
    invoke-static {v0}, Landroidx/core/graphics/drawable/IconCompat;->q(Landroid/graphics/drawable/Icon;)Ljava/lang/String;
...
.method public s()I
    ...
    invoke-static {v0}, Landroidx/core/graphics/drawable/IconCompat;->t(Landroid/graphics/drawable/Icon;)I
...
.method public u()Landroid/net/Uri;
    ...
    invoke-static {v0}, Landroidx/core/graphics/drawable/IconCompat;->v(Landroid/graphics/drawable/Icon;)Landroid/net/Uri;
...
.method public x(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    invoke-direct {p0, p1}, Landroidx/core/graphics/drawable/IconCompat;->y(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, v0}, Landroidx/core/graphics/drawable/a;->b(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
