.class public Landroidx/media/d/a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/media/d/a;->e:[I
...
.method private A(Landroidx/core/app/g$a;)Landroid/widget/RemoteViews;
    ...
    invoke-virtual {p1}, Landroidx/core/app/g$a;->e()I
...
.method public b(Landroidx/core/app/f;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/media/d/a;->x(Landroid/app/Notification$MediaStyle;)Landroid/app/Notification$MediaStyle;
    ...
    :cond_0
    iget-boolean v0, p0, Landroidx/media/d/a;->g:Z
...
.method public s(Landroidx/core/app/f;)Landroid/widget/RemoteViews;
    ...
    :cond_0
    invoke-virtual {p0}, Landroidx/media/d/a;->y()Landroid/widget/RemoteViews;
...
.method public t(Landroidx/core/app/f;)Landroid/widget/RemoteViews;
    ...
    :cond_0
    invoke-virtual {p0}, Landroidx/media/d/a;->z()Landroid/widget/RemoteViews;
...
.method x(Landroid/app/Notification$MediaStyle;)Landroid/app/Notification$MediaStyle;
    ...
    iget-object v0, p0, Landroidx/media/d/a;->e:[I
    ...
    :cond_0
    iget-object v0, p0, Landroidx/media/d/a;->f:Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method y()Landroid/widget/RemoteViews;
    ...
    iget-object v0, v0, Landroidx/core/app/g$e;->b:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, Landroidx/media/d/a;->B(I)I

    move-result v1

    const/4 v2, 0x0

    invoke-virtual {p0, v2, v1, v2}, Landroidx/core/app/g$i;->c(ZIZ)Landroid/widget/RemoteViews;
    ...
    iget-object v4, v4, Landroidx/core/app/g$e;->b:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v4}, Landroidx/media/d/a;->A(Landroidx/core/app/g$a;)Landroid/widget/RemoteViews;
    ...
    iget-object v2, p0, Landroidx/media/d/a;->h:Landroid/app/PendingIntent;
...
.method z()Landroid/widget/RemoteViews;
    ...
    invoke-virtual {p0}, Landroidx/media/d/a;->C()I
    ...
    iget-object v4, p0, Landroidx/media/d/a;->e:[I
    ...
    iget-object v6, p0, Landroidx/core/app/g$i;->a:Landroidx/core/app/g$e;

    iget-object v6, v6, Landroidx/core/app/g$e;->b:Ljava/util/ArrayList;

    iget-object v7, p0, Landroidx/media/d/a;->e:[I
    ...
    invoke-direct {p0, v6}, Landroidx/media/d/a;->A(Landroidx/core/app/g$a;)Landroid/widget/RemoteViews;
    ...
    :cond_2
    iget-boolean v2, p0, Landroidx/media/d/a;->g:Z
    ...
    iget-object v1, p0, Landroidx/media/d/a;->h:Landroid/app/PendingIntent;
