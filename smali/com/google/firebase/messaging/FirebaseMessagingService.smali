...
.super Lcom/google/firebase/messaging/k0;
.source ""
...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, Lcom/google/firebase/messaging/k0;-><init>()V
...
.method private m(Landroid/content/Intent;)V
    ...
    invoke-direct {v1, v0}, Lcom/google/firebase/messaging/s0;-><init>(Landroid/os/Bundle;)V
    ...
    invoke-direct {v3, p0, v1, v2}, Lcom/google/firebase/messaging/j0;-><init>(Landroid/content/Context;Lcom/google/firebase/messaging/s0;Ljava/util/concurrent/ExecutorService;)V

    :try_start_0
    invoke-virtual {v3}, Lcom/google/firebase/messaging/j0;->a()Z
    ...
    :cond_1
    invoke-static {p1}, Lcom/google/firebase/messaging/q0;->A(Landroid/content/Intent;)Z

    move-result v1

    if-eqz v1, :cond_2

    invoke-static {p1}, Lcom/google/firebase/messaging/q0;->t(Landroid/content/Intent;)V
    ...
    invoke-direct {p1, v0}, Lcom/google/firebase/messaging/w0;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {p0, p1}, Lcom/google/firebase/messaging/FirebaseMessagingService;->q(Lcom/google/firebase/messaging/w0;)V
...
.method private u(Landroid/content/Intent;)V
    ...
    invoke-direct {v1, p1}, Lcom/google/firebase/messaging/z0;-><init>(Ljava/lang/String;)V
    ...
    :pswitch_2
    invoke-static {p1}, Lcom/google/firebase/messaging/q0;->v(Landroid/content/Intent;)V
...
.method protected c(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-virtual {p1}, Lcom/google/firebase/messaging/a1;->c()Landroid/content/Intent;
